# Webstercrew WAT
**Webstercrew WAT** is a theme based on **WhatATheme** customizable Jekyll Portfolio theme which supports blogging. You can use this theme in order to create an elegant, fully responsive portfolio.
...
* Build the site by running `bundle exec jekyll build`
